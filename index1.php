...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      ...
      <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#">O nás <span class="caret"></span></a>
      </li>
      <li><a href="#">Prihlásenie/Registrácia</a></li>
      <li><a href="#">Kontakt</a></li>
    </ul>
    <ul class="nav navbar-nav navbar-right">
      <iframe src="https://www.facebook.com/DoraBus-1334727099880570/" 
				width="10%" height="10%" frameborder="0" style="border-radius:5%" allowfullscreen></iframe>
    </ul>
  </div>
</nav>
...
<div id="main" style="width: 1000px; margin: 0 auto;">
  ...
  <div style="margin:20px;">
    ...
    Odkiaľ:
      <select>
        ...
        <option value="bratisl  ava">Bratislava</option>
        <option value="banska">Banská bystrica</option>
  ...
  <button type="button">Vyhľadaj </button>
   </div>
   </form>
   </div>
   </div>
